...
//
//class PendingCheckServicePlugin(context: Context, newMethodChannel: MethodChannel) : Activity(),
//    MethodCallHandler {
...
//
//
//    private var channel: MethodChannel = newMethodChannel
//
...
//            val channel = MethodChannel(registrar.messenger(), "pending_check_service")
